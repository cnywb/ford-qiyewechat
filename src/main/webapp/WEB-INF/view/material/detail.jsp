        ...
        <div class="content-container">
            <div class="row">
                <div class="col-md-12" role="main">
                    ...
                    <div class="row area-list-dec">     
                    	 <div class="area-search">
                             <form class="form-inline" role="form"  method="post"
                                   id="searchForm"  name="searchForm" action="detail.do?materialId=${vo.materialId}">
                                 <input    name="materialId" type="hidden"  value="${vo.materialId}">
                    ...
                    <xq:page pagination="${page}" formId="searchForm" action="detail.do?materialId=${vo.materialId}" />
                </div>
            </div>
        </div>
    </div>
