...
**/
//图片上传地址
var imgUploadServer = hhutil.getRootPath()+"/backer/uploadimg!uploadImgFlash.action";
var imgUploadThumbServer = hhutil.getRootPath()+"/backer/uploadimg!uploadImgThumbFlash.action";
