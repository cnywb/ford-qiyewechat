...
<div class="main_bg">  
  <div class="jptg_list">
  	<ul>
        ...
        <li>
        	<a>
            	<div style="width:20%;" class="txt"><s:property value="#item.materialname"/></i></div>
                <div style="width:20%" class="txt"><s:property value="#item.materialcontent"/></i></div>
                <div style="width:20%" class="txt"><s:property value="#item.realname"/></div>
                <div style="width:20%" class="txt"><s:property value="#item.createtime"/></div>
                <div style="width:20%" class="txt"><a style='color: blue' onclick="OutputStream('<s:property value="#item.materialname"/>','<s:property value="#item.timestamp"/>','<s:property value="#item.materialcontent"/>')" >下载</a></div>
                <div class="clear"></div>
            </a>
        </li>
       </s:iterator>
    ...
    <script type="text/javascript">
	function OutputStream(url,timestamp,content){
		  
		var urls="http://www.changanfordqiyehao.com/backer/download!execute.action?filename="+url+"&stamp="+timestamp+"&user="+'${userid}';
