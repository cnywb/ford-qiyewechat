...
public class HttpConnectionUtil {
	...
	public static String uploadQyMedia(String requestUrl,InputStream fileInputStream,String contentType,String fileName) {
		log.info("发起接口请求:"+requestUrl);
		String boundary = "------------7da2e536604c8";
		String retVal = null;
		StringBuffer buffer = new StringBuffer();
	...
	public static String uploadQyMedia(String requestUrl,MultipartFile file) throws IOException {
	   return uploadQyMedia(requestUrl, file.getInputStream(), file.getContentType(), file.getOriginalFilename());
	}
