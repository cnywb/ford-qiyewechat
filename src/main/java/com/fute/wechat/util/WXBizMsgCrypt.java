...
public class WXBizMsgCrypt {
	...
	public WXBizMsgCrypt(String token, String encodingAesKey, String corpId) throws AesException {
		if (encodingAesKey.length() != 43) {
			throw new AesException(AesError.IllegalAesKey);
		}
	...
	String encrypt(String randomStr, String text) throws AesException {
		...
		try {
			...
			e.printStackTrace();
			throw new AesException(AesError.EncryptAESError);
		}
	}
	...
	String decrypt(String text) throws AesException {
		...
		try {
			...
			e.printStackTrace();
			throw new AesException(AesError.DecryptAESError);
		}
		...
		try {
			...
			e.printStackTrace();
			throw new AesException(AesError.IllegalBuffer);
		}

		// corpid不相同的情况
		if (!from_corpid.equals(corpId)) {
			throw new AesException(AesError.ValidateCorpidError);
		}
		return xmlContent;
	...
	public String DecryptMsg(String msgSignature, String timeStamp, String nonce, String postData)
		...
		if (!signature.equals(msgSignature)) {
			throw new AesException(AesError.ValidateSignatureError);
		}
