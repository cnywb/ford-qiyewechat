...
public interface BatteryService {
	boolean updateFirstAddressChange(String openid, String addressupdatesource);
	//更新用户第一条访问兑换记录
	...
	//互动记录
	List<Map<String, Object>> getInteractionList(Map<String, Object> data);
	Integer getInteractionListNum(Map<String, Object> data);
	...
	//充电Banner
	Map<String, Object> getMlBannerCharg(Map<String, Object> data);
	List<Map<String, Object>> getMlBannerChargList(Map<String, Object> data);
	Integer getMlBannerChargListNum(Map<String, Object> data);
	void updateMlBannerCharg(Map<String, Object> data);
	void insertMlBannerCharg(Map<String, Object> data);
	void deleteMLBannerCharg(Map<String, Object> data);
