...
public interface BasicMapper {
	...
	public List<Map<String, Object>> getEmployeeIdList(Map<String, Object> data);
	...
	void deleteUserMark(Map<String, Object> data);
	
	void saveUserMark(Map<String, Object> data);
	//获取下级部门
