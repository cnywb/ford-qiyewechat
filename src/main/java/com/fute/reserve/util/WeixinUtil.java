...
import com.fute.common.util.FileUtil;
import com.fute.common.util.HttpClient;
import com.fute.reserve.pojo.Button;
import com.fute.reserve.pojo.Menu;
...
public class WeixinUtil {
	...
	public String GetTokenRequest = "https://qyapi.weixin.qq.com/cgi-bin/user/getuserinfo?access_token="+wx.getAccessToken()+"&code=CODE";
	...
	public String getInfo(String code) {
		...
		if (null == code || "".equals(code)) {
			code = null != session.get("code") ? session.get("code").toString()
					: "";
		} else {
