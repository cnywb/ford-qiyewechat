...
import com.fute.reserve.util.Weixin509TrustManager;
...
public class HttpRequest {
	 ...
	 * @return JSONObject
	 */
	public static JSONObject httpRequestForm(String requestUrl,File file,JSONObject fileJson){
...
//			+ access_token + "&type=" + fileType;
		...
		try {
			...
			+filename+";filelength=\""+file.length()+";Content-Type=\""+contentType+end);
			dos.writeBytes(end);
			//对文件进行传输
